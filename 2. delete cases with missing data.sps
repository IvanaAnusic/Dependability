GET  FILE='C:\Users\Ivana\Documents\Research\FIRST YEAR PROJECT\Final Files\POTorganizedTemp.sav'.
...
(9999).
comp distmis = distmis/8.


list lsmis to distmis.

comp wavemis = max(lsmis to distmis).
sort cases by wavemis.
list lsmis to wavemis.
...
delete variables lsmis to wavemis.
formats w1a1 to w9o4 (F8.3).

SAVE OUTFILE='C:\Users\Ivana\Documents\Research\FIRST YEAR PROJECT\Final Files\POTorganized.sav'.
